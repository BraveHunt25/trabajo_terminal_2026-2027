...
\cdtInstrucciones{
	...
	Este documento contiene el análisis de requerimientos del proyecto ``{\em \Proyecto}'' que servirá como base para el análisis, diseño, construcción, pruebas y aceptación del proyecto.
