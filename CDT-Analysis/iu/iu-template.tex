...
\begin{itemize}
	\item \IUbutton{Entrar}: Verifica que el Estudiante se encuentre registrado y la contraseña sea la correcta. Si la verificación es correcta, se muestra la Pantalla de Selección de Seminario.
	\item \IUbutton{Ayuda}: Muestra la ayuda de esta pantalla: Pantalla de Ayuda.
\end{itemize}
